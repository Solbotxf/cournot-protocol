...
Compatible interface: same inputs/outputs as CollectorWebPageReader.
"""
...
# ---------------------------------------------------------------------------
# System prompts (reused from CollectorWebPageReader)
# ---------------------------------------------------------------------------
...
class PANCollectorAgent(BaseAgent):
    ...
    # ------------------------------------------------------------------
    # Validation (same as CollectorWebPageReader)
    # ------------------------------------------------------------------
